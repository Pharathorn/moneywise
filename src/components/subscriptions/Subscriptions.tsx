            ...
            <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.375rem' }}>
              <button
                style={{
                  ...
                  padding: '0.5rem 1rem',
                  borderRadius: '8px',
                  border: `2px solid ${form.active ? '#22c55e' : 'var(--border)'}`,
                  background: form.active ? '#f0fdf4' : 'var(--bg-card)',
                  color: form.active ? '#16a34a' : 'var(--text-muted)',
                  fontSize: '0.8125rem',
                  fontWeight: 500,
                  cursor: 'pointer',
                }}
              ...
              <button
                style={{
                  ...
                  padding: '0.5rem 1rem',
                  borderRadius: '8px',
                  border: `2px solid ${!form.active ? '#ef4444' : 'var(--border)'}`,
                  background: !form.active ? '#fef2f2' : 'var(--bg-card)',
                  color: !form.active ? '#dc2626' : 'var(--text-muted)',
                  fontSize: '0.8125rem',
                  fontWeight: 500,
                  cursor: 'pointer',
                }}
